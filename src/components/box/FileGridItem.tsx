...
export function FileGridItem({ file, previewUrl }: Props) {
  ...
  return (
    <>
      <div className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900">
        {/* Thumbnail area */}
